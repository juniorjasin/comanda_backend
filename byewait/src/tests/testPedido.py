...
class TestPedido(Test):
    ...
    def test_postCorrectBody(self):
        body = '{"order":{"user": {"id_user": 1, "nombre": "nombretest", "apellido": "apellidotest"}, "id_restaurante":1,"id_mesa":3, "items":[{"id":"1","cantidad": 3,"aclaraciones": "sin ajo", "opciones":[]},{"id":"2","cantidad": 1,"aclaraciones": "sin queso", "opciones":[]}]}}'
        headers = {'Authorization': token}
        response = requests.post("http://localhost:8888/restaurante/pedido", data=body, headers=headers)
